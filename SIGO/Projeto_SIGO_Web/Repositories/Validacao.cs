...
namespace Projeto_SIGO_Web.Repositories
{
    ...
    {
        //Valida Versão;
        public bool IsVersao(string versao)
        {
            versao = versao.Trim();
            versao = versao.Replace(".", "").Replace("_", "");
        ...
        public bool IsTelefone(string telefone)
        {
            ...
            telefone = telefone.Replace("(", "").Replace(")", "").Replace("-", "").Replace("_", "").Replace(" ", "");
        ...
        public bool IsCnpj(string cnpj)
        {
            ...
            cnpj = cnpj.Trim();
            cnpj = cnpj.Replace(".", "").Replace("-", "").Replace("/", "").Replace(" ", "").Replace("_","");
